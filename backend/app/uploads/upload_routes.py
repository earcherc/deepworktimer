...
async def upload_profile_photo(
    ...
    profile_photo_key = await process_and_upload_image(
...
async def get_profile_photo_view_url(
    ...
    if user.profile_photo_url:
        return {
            ...
            "medium": await generate_profile_photo_view_url(
                user.profile_photo_medium_url
            ),
            "thumbnail": await generate_profile_photo_view_url(
