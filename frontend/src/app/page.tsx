...
import { ChartBarIcon, ClockIcon, UsersIcon } from '@heroicons/react/20/solid';
...
const footerNavigation = {
  social: [
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/earcherc/deepworktimer',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
  ...
  return (
    <div className="bg-white">
      ...
      <main>
        ...
        <div className="mx-auto mt-8 max-w-7xl sm:mt-14 sm:px-6 lg:px-8">
        ...
        <div className="relative isolate mt-14 sm:mt-32 sm:pt-14">
          <svg
          ...
          <div className="border-t border-white/10 pt-8 lg:flex lg:items-center lg:justify-between">
            ...
            <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
              ...
              <div className="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="flex w-full items-center justify-center rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 opacity-50 cursor-not-allowed"
                  disabled
                >
                  Subscribe
                </button>
          ...
          <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
            <div className="flex space-x-6 md:order-2">
              {footerNavigation.social.map((item) => (
                <a target="_blank" key={item.name} href={item.href} className="text-gray-500 hover:text-gray-400">
            ...
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              &copy; {new Date().getFullYear()} Clai Studios, LLC. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
